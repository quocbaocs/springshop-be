package com.quocbao.springshop.service;
...
import com.quocbao.springshop.exception.CategoryException;
import com.quocbao.springshop.model.Category;
import com.quocbao.springshop.repository.CategoryRepository;
...
public class CategoryService {
	...
	public Category update(Long id, Category entity) {
		...
		if (existed.isEmpty()) {
			throw new CategoryException("Caegory id " + id + " does not exist");
